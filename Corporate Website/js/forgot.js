document.addEventListener('DOMContentLoaded', function() {
    ...
    if (optPasswordOnly && optBoth) {
        optPasswordOnly.addEventListener('click', function() {
            ...
            step2Subtitle.textContent = "We have sent a Personal Authentication Code (PAC) to your registered mobile number.";
        ...
        optBoth.addEventListener('click', function() {
            ...
            step2Subtitle.textContent = "Retrieve your Corporate User ID and verify credentials using SMS PAC.";
            pacMessage.innerHTML = "PAC Sent to XXX12XXXXX3. number XXX3ZXXXXX1.<br>Security Number: QD5788156.";
    ...
    if (step1Form) {
        step1Form.addEventListener('submit', function(e) {
            ...
            // Pre-configure Step 2 if Forgot Both
            if (selectedOption === 'both') {
                useridRetrievalContainer.classList.add('d-none'); // Hidden until PAC is entered or clicked
            } else {
                useridRetrievalContainer.classList.add('d-none');
            }
        });
    }
        ...
        pacInput.addEventListener('input', function() {
            ...
            if (val.length === 8) {
                if (val === correctPAC) {
                    ...
                    // Enable next button
                    if (btnNext2) btnNext2.removeAttribute('disabled');
                    ...
                    if (btnNext2) btnNext2.setAttribute('disabled', 'true');
                }
            } else {
    ...
    if (step2Form) {
        step2Form.addEventListener('submit', function(e) {
            ...
            // Configure Step 3 password layout
            if (selectedOption === 'both') {
                useridCalloutStep3.classList.remove('d-none');
                recoveredUseridStep3.textContent = "franklinjunior01";
            } else {
                useridCalloutStep3.classList.add('d-none');
            }
    ...
    // --- Password Validation Logic (Step 3) ---
